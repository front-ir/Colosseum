...
def foo():
    ...
    data_path = os.path.join(script_path, "screenshots", "yolo1.yaml")
    model.train(data=data_path, epochs=50, batch=64, imgsz=640, device='cuda', workers=8, patience=15, optimizer='auto')
